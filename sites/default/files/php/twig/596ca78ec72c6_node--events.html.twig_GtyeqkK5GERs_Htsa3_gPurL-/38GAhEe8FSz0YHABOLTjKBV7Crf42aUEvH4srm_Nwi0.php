...
/* themes/bootstrap_subtheme/templates/node--events.html.twig */
class __TwigTemplate_d82477cf880cebd9dbacdcc365ef206c438fcc19055ddd1dafae29bf274bbd17 extends Twig_Template
{
    ...
    {
        $tags = array("set" => 69, "if" => 81, "trans" => 93);
        $filters = array("clean_class" => 70, "date" => 92);
        $functions = array();
...
(isset($context["view_mode"]) ? $context["view_mode"] : null)) ? (\Drupal\Component\Utility\Html::getClass((isset($context["view_mode"]) ? $context["view_mode"] : null))) : ("")), 5 => "clearfix");
  ...
  ";
      ...
      <div";
        ...
        ";
            // line 92
            $context["createdDate"] = twig_date_format_filter($this->env, $this->getAttribute((isset($context["node"]) ? $context["node"] : null), "getCreatedTime", array()), "Y F j");
            // line 93
            echo "        ";
            echo t("Submitted on @dates", array("@dates" => (isset($context["dates"]) ? $context["dates"] : null), ));
            // line 94
            echo "        ";
...
";
    ...
    {
        return "themes/bootstrap_subtheme/templates/node--events.html.twig";
    }
    ...
    {
        return array (  114 => 100,  110 => 99,  107 => 98,  99 => 94,  96 => 93,  94 => 92,  90 => 91,  86 => 90,  83 => 89,  81 => 88,  75 => 86,  67 => 83,  62 => 82,  60 => 81,  56 => 80,  50 => 78,  48 => 74,  47 => 73,  46 => 72,  45 => 71,  44 => 70,  43 => 69,);
    }
  ...
  {% if display_submitted %}
    <footer>
      ...
      <div{{ author_attributes.addClass('author') }}>
        {% set createdDate = node.getCreatedTime|date('Y F j') %}
        {% trans %}Submitted on {{ dates }} {% endtrans %}
        {{ metadata }}
      </div>
    </footer>
  {% endif %}
